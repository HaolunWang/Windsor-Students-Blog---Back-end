...
const uri = "mongodb+srv://liu1ia@uwindsor.ca:<Lrt%4019911016>@mycluster-6uiwj.mongodb.net/test?retryWrites=true";
const client = new MongoClient(uri, { useNewUrlParser: true });
client.connect(err => {
  const collection = client.db("S2G3Project2").collection("S2G3");
